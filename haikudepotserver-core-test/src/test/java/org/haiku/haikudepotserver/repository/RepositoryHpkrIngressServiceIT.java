...
public class RepositoryHpkrIngressServiceIT extends AbstractIntegrationTest {
    ...
    @Test
    public void testImportThenCheck(@TempDir File temporaryDir) throws Exception {

        File temporaryRepoFile = new File(temporaryDir, "repo");
        File temporaryRepoInfoFile = new File(temporaryDir, "repo.info");
...

        {
            ...
            pkgService.ensurePkgProminence(context, pkg, Repository.getByCode(context, "test"));
            pkgService.ensurePkgProminence(context, pkg, Repository.getByCode(context, "test2"));
            ...
            // this one should get deactivated
            {
                ...
                pkgVersion.setArchitecture(Architecture.getByCode(context, "x86_64"));
                pkgVersion.setIsLatest(true);
                pkgVersion.setRepositorySource(RepositorySource.getByCode(context, "testsrc_xyz"));
            }
            ...
            // this one should remain
            {
                ...
                pkgVersion.setArchitecture(Architecture.getByCode(context, "x86_64"));
                pkgVersion.setIsLatest(true);
                pkgVersion.setRepositorySource(RepositorySource.getByCode(context, "testsrc2_xyz"));
            }
...

        {
...

            {
                ...
                Assertions.assertThat(PkgVersion.findForPkg(
                                context,
                                pkgVersion.getPkg(),
                                RepositorySource.getByCode(context, "testsrc_xyz"),
                                true).size())
