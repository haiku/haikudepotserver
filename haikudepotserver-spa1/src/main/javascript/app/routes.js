...
angular.module('haikudepotserver').config(
    [
        ...
        function($routeProvider) {
            ...
            var controllerTemplatePathPrefix = '/__js/app/controllertemplate';
            ...
            $routeProvider
                ...
                .when(repositorySourcePrefix + '/edit', {controller:'AddEditRepositorySourceController',templateUrl:controllerTemplatePathPrefix + '/addeditrepositorysource.html'})
                .when(repositorySourcePrefix, {controller:'ViewRepositorySourceController',templateUrl:controllerTemplatePathPrefix + '/viewrepositorysource.html'})
                .when(repositorySourcePrefix + '/mirrors/add', {controller:'AddEditRepositorySourceMirrorController',templateUrl:controllerTemplatePathPrefix + '/addeditrepositorysourcemirror.html'})
                .when(repositorySourcePrefix + '/mirror/:repositorySourceMirrorCode', {controller:'ViewRepositorySourceMirrorController',templateUrl:controllerTemplatePathPrefix + '/viewrepositorysourcemirror.html'})
                .when(repositorySourcePrefix + '/mirror/:repositorySourceMirrorCode/edit', {controller:'AddEditRepositorySourceMirrorController',templateUrl:controllerTemplatePathPrefix + '/addeditrepositorysourcemirror.html'})
