...
public enum Permission {
    ...
    PKG_EDITNATIVEDESKTOP(TargetType.PKG), // means edit the meta-data about a version + enabled / disabled
    ...
    BULK_PKGSCREENSHOTEXPORTARCHIVE(null),
    BULK_PKGSCREENSHOTIMPORTARCHIVE(null),
