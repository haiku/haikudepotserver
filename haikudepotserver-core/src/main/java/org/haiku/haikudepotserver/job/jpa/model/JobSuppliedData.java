...
@Entity
@Table(schema = "job", name = "job_supplied_data")
public class JobSuppliedData {

    @Id
    @Column(name = "id", nullable = false)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "job_supplied_data_seq")
    @SequenceGenerator(name = "job_supplied_data_seq", schema = "job", sequenceName = "job_supplied_data_seq", allocationSize = 1)
    private Long id;
