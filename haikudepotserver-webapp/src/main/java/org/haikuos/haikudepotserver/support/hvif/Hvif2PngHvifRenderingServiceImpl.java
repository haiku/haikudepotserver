...
import org.haikuos.haikudepotserver.support.AbstractExternalToolService;
...
/**
 * <p>Renders the HVIF vector icon to PNG using the command line tool that can be built as part of the Haiku-OS
