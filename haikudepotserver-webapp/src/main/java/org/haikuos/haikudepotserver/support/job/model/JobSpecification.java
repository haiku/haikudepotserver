 ...
 * not know what {@link org.haikuos.haikudepotserver.support.job.JobRunner} should be used to run the job, but can
 * specify the data that a {@link org.haikuos.haikudepotserver.support.job.JobRunner} might need in order to be able
 * to operate.</p>
 */
...
public interface JobSpecification {
     ...
     * {@link org.haikuos.haikudepotserver.support.job.JobRunner} allows an instance of
     * {@link org.haikuos.haikudepotserver.support.job.JobOrchestrationService} to find a runner which is
     ...
     * {@link org.haikuos.haikudepotserver.support.job.JobOrchestrationService}, it is possible to coalesce
