...
public class PkgChangelogControllerIT extends AbstractIntegrationTest {
    ...
    @Test
    public void testPkgChangelog_html() throws Exception {
        IntegrationTestSupportService.StandardTestData testData = integrationTestSupportService.createStandardTestData();
        String url = UriComponentsBuilder.fromUriString("http://localhost/__multipage/pkg/pkg1/changelog")
                .build()
                .toUriString();
        ...
        {
            DomElement homePkgContainerEl = page.getElementById("pkg-changelog-content-container");
            Assertions.assertThat(homePkgContainerEl.getTextContent()).contains("Karlsruhe");
        }
